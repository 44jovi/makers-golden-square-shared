...
RSpec.describe "doubles" do
  ...
  it "sets up a double with methods" do
    ...
    # alternative 1 - warning each line overwrites previous line
    # fake_object = double(:doubles, speak: "Meow")
    # fake_object = double(:doubles, count_ears: "2")
    # fake_object = double(:doubles, count_legs: "4")
    ...
    # alternative 3
    fake_object = double(:doubles, speak: "Meow", count_ears: 2, count_legs: 4)
  ...
  it "sets up a double with methods that take arguments" do
    # Set up your doubles here
    fake_object = double(:quack)
    expect(fake_object).to receive(:speak).with("Jess").and_return("Meow, Jess")
    # next line is experiment 1
    # expect(fake_object).to receive(:speak).with("Ron").and_raise(RSpec::Mocks::MockExpectationError)
    # Don't edit below
